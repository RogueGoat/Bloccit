...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "PUT #update" do
    it "updates the question with expected attributes" do
      ...
      put :update, id: my_question.id, question: { title: new_title, body: new_body, resovled: false}
    ...
    it "redirects user to updated question" do
      new_title = RandomData.random_sentence
      new_body = RandomData.random_paragraph
  ...
  describe "DELETE destroy" do
    it "deletes the question selected" do
